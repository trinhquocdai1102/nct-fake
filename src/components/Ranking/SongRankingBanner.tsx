...
const SongRankingBanner: React.FC<SongRankingBannerProps> = ({
    data,
    handlePlayAll,
}) => {
    return (
        <div
            className='mt-5 p-5 bg-gray-100 rounded-md md:flex hidden cursor-pointer'
            ...
            <div className='flex-1 ml-5'>
                ...
                <div className='mt-5 grid grid-cols-3'>
                    <div>
                        ...
                        <p className='text-gray-400 mt-3 lg:text-base text-xs'>
                            TUẦN TRƯỚC
                        </p>
                    </div>
                    <div>
...
export default SongRankingBanner;
